    ...
    #endif
    {
        ...
        private void LogBasics()
        {
            if (this.client != null)
            {
                ...
                sb.AppendFormat("NameServer: {0} Current Server: {1} IP: {2} Region: {3} ", this.client.NameServerHost, this.client.CurrentServerAddress, this.client.LoadBalancingPeer.ServerAddress, this.client.CloudRegion);
        ...
        void IInRoomCallbacks.OnRoomPropertiesUpdate(System.Collections.Hashtable propertiesThatChanged)
        {
            throw new System.NotImplementedException();
        }

        void IInRoomCallbacks.OnPlayerPropertiesUpdate(Player targetPlayer, System.Collections.Hashtable changedProps)
        {
            throw new System.NotImplementedException();
        }
