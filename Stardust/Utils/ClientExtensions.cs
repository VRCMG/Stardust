...
namespace Stardust.Utils
{
    ...
    public static class ClientExtensions
    {
        ...
        public static void JoinRoom(this DustClient client, string RoomID)
        {
        ...
        public static void Instantiate(this DustClient client, Vector3 Position, Quaternion Rotation)
        {
        ...
        public static Player GetPlayer(this DustClient client, string userid)
        {
        ...
        public static string GetCurrentRoom(this DustClient client)
        {
        ...
        public static void JoinCurrentRoom(this DustClient client)
        {
            var currentRoom = client.GetCurrentRoom();
            client.JoinRoom(currentRoom.ToString());
        }

        public static Hashtable Instantiate(this DustClient client, string prefabName, Vector3 position, Quaternion rotation, int[] viewIDs)
        {
            int num = viewIDs[0];
            Hashtable hashtable = new Hashtable();
        ...
        public static void RPC(this DustClient client, int[] viewIDs, string MethodName, RpcTarget target, bool encrypt, params object[] parameters)
        {
        ...
        public static void RegisterTypes(this DustClient client)
        {
        ...
        public static void SetAuthentication(this DustClient client, string authCookie, string userID)
        {
        ...
        public static void SetCustomProperties(this DustClient client, string authCookie, string userID, string avatarID)
        {
        ...
        public static void SetCustomProperties(this DustClient client, Hashtable table) => client.LocalPlayer.SetCustomProperties(table);
    }
}
